...
public class Projects extends PoisedInputChecks {
    ...
    public void addProject(Statement statement) throws SQLException {
         ...
         * The information inserted by the user is inserted into the appropriate columns,
    ...
    // This method allows users to view all project objects that are overdue in the main_project_info table in the
    // external 'PoisePMS' database.
