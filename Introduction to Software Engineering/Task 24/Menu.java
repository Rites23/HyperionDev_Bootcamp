...
// PoisedMenu is a subclass that inherits methods from the InputCheck superclass.
// This class runs the main program method and calls other methods from the Project, Person and ExistingProjects
// classes.
// It displays a main menu to the user with options for the Poised Management System.

public class Menu extends InputChecks {  // Class declaration
    ...
    public static void main(String[] args) throws ParseException {  // Main method declaration.
        ...
        // Thereafter, the system creates a 'CurrentProjects.txt.' file to store project info, if it does not exist
        // already.
        ...
        // file check is run to determine if there are existing projects and, if not, the user is prompted
        // to choose option '2' to create a new project object.
        // Various methods from the Project, Person, and ExistingProjects classes are called on, depending on the
        // users selected option. For example, the Project() method from Project class is called on for option '2'.
        ...
        while (true) {
            ...
            int userChoice = intCheck("menu choice");  // Checking integer input with method from the InputChecks class.
